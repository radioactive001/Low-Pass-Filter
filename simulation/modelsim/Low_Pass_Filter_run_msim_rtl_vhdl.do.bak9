...
vcom -93 -work work {I:/My Drive/FPGA/Low_Pass_Filter/Low_Pass_Filter.vhd}
vcom -93 -work work {I:/My Drive/FPGA/Low_Pass_Filter/N_Bit_Register.vhd}

vcom -93 -work work {I:/My Drive/FPGA/Low_Pass_Filter/Test_Low_Pass_Filter.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev -L cyclonev_hssi -L rtl_work -L work -voptargs="+acc"  Test_Low_Pass_Filter
